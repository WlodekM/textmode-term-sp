...
class FileDescriptorManager {
  ...
  _counter: Counter;
  _fds: Map<number, FileDescriptor<any>>;
   ...
   */
    //@ts-ignore
  createFd (iNode: $Subtype<INode>, flags: number): [FileDescriptor<any>, number] {
   ...
   */
  getFd (index: number): FileDescriptor<any> | undefined {
   ...
   */
  dupFd (index: number): number | undefined {
